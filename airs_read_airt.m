...
data1 = hdfread(FILE_NAME, '/ascending/Data Fields/Temperature_A', 'Index', {[1  1  1],[1  1  1],[24  180  360]});
...
%%%% Extracting Land only data (Size should be 177499) %%%%%%%%%%%%%%%%%%      
      LANDT(:,lev,day)=T(cellN);
end;

end
save(['/Volumes/G-RAIDT/Emissivity-AMSR2/TEMP/2016/AIRS_TEMP_ASC_' mon '2016.mat'],'LANDT');
end;
